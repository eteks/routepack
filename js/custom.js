...
jQuery(document).ready(function(){
	...
	$(".digits_only").keypress(function (e) {  //called when key is pressed in textbox
			if (e.which != 8 && e.which != 0 && (e.which < 48 || e.which > 57)) {  //if the letter is not digit then display error and don't type anything
   			return false;
